# Generated by Django 3.2.3 on 2021-06-27 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('do_not_display', models.BooleanField(default=False, help_text='**Check this box to hide the specific styling.', verbose_name='Do not display')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='SiteCustomisations',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('style_name', models.CharField(help_text='"Halloween Theme..."', max_length=20)),
                ('page_title_colors', colorfield.fields.ColorField(default='#000000', max_length=18)),
                ('main_site_background', colorfield.fields.ColorField(default='#FFFFFF', max_length=18)),
                ('home_page', models.ForeignKey(default='id', on_delete=django.db.models.deletion.CASCADE, to='page_customisations.homepagecustomisation')),
            ],
        ),
    ]
